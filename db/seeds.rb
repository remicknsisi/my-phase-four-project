...
Student.create(year: 3, house: 'Gryffindor', name: 'Harry Potter', image:'https://fantasytopics.com/wp-content/uploads/2022/06/Harry-Potter.jpg.webp')
Student.create(year: 3, house: 'Gryffindor', name: 'Ron Weasley', image:'https://fantasytopics.com/wp-content/uploads/2022/06/Ron-Weasley.jpg.webp')
Student.create(year: 3, house: 'Gryffindor', name: 'Hermione Granger', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Hermione-Granger.jpg.webp')
Student.create(year: 3, house: 'Slytherin', name: 'Draco Malfoy', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Draco-Malfoy.jpg.webp')
Student.create(year: 4, house: 'Ravenclaw', name: 'Cho Chang', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Cho-Chang.jpg.webp')
Student.create(year: 5, house: 'Hufflepuff', name: 'Cedric Diggory', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Cedric-Diggory.jpg.webp')
Student.create(year: 3, house: 'Gryffindor', name: 'Dean Thomas', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Dean-Thomas.jpg.webp')
Student.create(year: 3, house: 'Slytherin', name: 'Vincent Crabbe', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Vincent-Crabbe.jpg.webp')
...
Student.create(year: 3, house: 'Gryffindor', name: 'Neville Longbottom', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/neville-longbottom.jpg.webp')
Student.create(year: 2, house: 'Gryffindor', name: 'Ginny Weasley', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Ginny-Weasley.jpg.webp')
Student.create(year: 3, house: 'Ravenclaw', name: 'Luna Lovegood', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Luna-Lovegood.jpg.webp')
Student.create(year: 3, house: 'Slytherin', name: 'Pansy Parkinson', image: 'https://fantasytopics.com/wp-content/uploads/2022/06/Pansy-Parkinson.jpg.webp')
